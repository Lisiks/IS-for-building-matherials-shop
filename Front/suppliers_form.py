...
class SuppliersForm(ctk.CTkFrame):
    def __init__(self, master, window_w, window_h):
        ...
        self.__creating_frame = self.__create_creation_frame(
            suppliers_inn_entry_w=round(11 * table_width_percentage),
            suppliers_name_entry_w=round(24 * table_width_percentage),
            suppliers_address_entry_w=round(30 * table_width_percentage),
            suppliers_telephone_entry_w=round(15 * table_width_percentage),
            suppliers_mail_entry_w=round(20 * table_width_percentage),
        ...
        self.__suppliers_table = CTkTable.CTkTable(
            master=self.__table_frame,
            values=[["ИНН\nпоставщика", "Наименование", "Физический адрес", "Телефон", "Электронная почта"]],
            row=12,
            column=5,
        ...
        self.__suppliers_table.edit_row(0, font=("Arial", font_size))
        self.__suppliers_table.edit_column(0, width=round(11 * table_width_percentage))
        self.__suppliers_table.edit_column(1, width=round(24 * table_width_percentage))
        self.__suppliers_table.edit_column(2, width=round(30 * table_width_percentage))
        self.__suppliers_table.edit_column(3, width=round(15 * table_width_percentage))
        self.__suppliers_table.edit_column(4, width=round(20 * table_width_percentage))
        ...
        self.__suppliers_table.grid(row=1, column=0, padx=3, pady=3)
    ...
    def __create_creation_frame(
        ...
        self.__suppliers_entry = ctk.CTkEntry(
        ...
        self.__suppliers_entry.grid(row=1, column=0, padx=2)
        self.__suppliers_name_entry.grid(row=1, column=1, padx=2)
        self.__suppliers_address_entry.grid(row=1, column=2, padx=2)
        self.__suppliers_telephone_entry.grid(row=1, column=3, padx=2)
        self.__suppliers_mail_entry.grid(row=1, column=4, padx=2)
