...
class NomenclatureForm(ctk.CTkFrame):
    def __init__(self, master, window_w, window_h):
        ...
        table_width = scrollbar_frame_width - 20
        table_height = scrollbar_frame_height - 20

        cell_table_height = table_height // 7

        table_width_percentage = table_width / 100
        ...
        self.__creating_frame = self.__create_creation_frame(
            ...
            name_entry_w=round(25 * table_width_percentage),
            buying_price_entry_w=round(10 * table_width_percentage),
            selling_price_entry_w=round(10 * table_width_percentage),
            type_entry_w=round(20 * table_width_percentage),
            unit_entry_w=round(20 * table_width_percentage),
        ...
        self.__nomenclature_table = CTkTable.CTkTable(
            master=self.__table_frame,
            values=[["Артикул", "Наименование", "Актуальная\nцена закупки", "Актуальная\nцена продажи", "Тип", "Ед. измерения", "Кол-во"]],
            row=12,
            column=7,
        ...
        self.__nomenclature_table.edit_row(0, font=("Arial", font_size))
        self.__nomenclature_table.edit_column(0, width=round(15 * table_width_percentage))
        self.__nomenclature_table.edit_column(1, width=round(25 * table_width_percentage))
        self.__nomenclature_table.edit_column(2, width=round(10 * table_width_percentage))
        self.__nomenclature_table.edit_column(3, width=round(10 * table_width_percentage))
        self.__nomenclature_table.edit_column(4, width=round(20 * table_width_percentage))
        self.__nomenclature_table.edit_column(5, width=round(10 * table_width_percentage))
        self.__nomenclature_table.edit_column(6, width=round(10 * table_width_percentage))
        ...
        self.__nomenclature_table.grid(row=1, column=0, padx=3, pady=3)
    ...
    def __create_creation_frame(
        ...
        self.__type_entry = ctk.CTkComboBox(
            master=creating_frame,
            width=type_entry_w,
            height=entryes_h,
            font=("Arial", font_size)
        ...
        self.__unit_entry = ctk.CTkComboBox(
            master=creating_frame,
            width=unit_entry_w,
            height=entryes_h,
            font=("Arial", font_size)
        ...
        self.__article_entry.grid(row=1, column=0, padx=2)
        self.__name_entry.grid(row=1, column=1, padx=2)
        self.__buying_price_entry.grid(row=1, column=2, padx=2)
        self.__selling_price_entry.grid(row=1, column=3, padx=2)
        self.__type_entry.grid(row=1, column=4, padx=2)
        self.__unit_entry.grid(row=1, column=5, padx=2)
