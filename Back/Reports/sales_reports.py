...
from Back.Reports.data_clasess import Product, Type, Client


def make_product_sales_report(period) -> list:
...
def make_type_sales_report(period) -> list:
    start_date, end_date = calculate_start_end_date_from_period(period)
...
def make_client_sales_report(period) -> list:
    start_date, end_date = calculate_start_end_date_from_period(period)
